...
abstract class AppColors {
  ...
  static const Color scaffoldBackground = Color.fromARGB(255, 245, 248, 252);
  ...
  /// The blue color 3685EB
  static const Color confirmedColor = Color(0xFF3685EB);

  /// The orange color.
  static const Color shippingColor = Color(0xFFFF9800); // Orange

  /// The green color.
  static const Color completedColor = Color(0xFF28A745); // Green

  /// The red color.
  static const Color canceledColor = Color(0xFFFF0000); // Red
}
